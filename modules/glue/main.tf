...
#   name = "dominio-${var.central_name}-my_connection"
#   connection_type = "JDBC"
#   connection_properties = {
#     # "JDBC_CONNECTION_URL" = "jdbc:aws:glue://${var.aws_glue_catalog_database}.${var.region}.glue.amazonaws.com"
#     # "JDBC_CONNECTION_URL" = "jdbc:aws:glue://dominio-dfajardo-data-base-catalog.us-east-2.glue.amazonaws.com"
